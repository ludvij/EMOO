...
void PPU::Serialize(std::ostream& fs)
{
	...
	Fman::SerializeStatic(fs, m_w);
	Fman::SerializeStatic(fs, m_w);
	Fman::SerializeStatic(fs, m_t);
	Fman::SerializeStatic(fs, m_frames);
	Fman::SerializeStatic(fs, m_scanline_done);
	Fman::SerializeStatic(fs, m_frame_done);
	Fman::SerializeStatic(fs, m_bg_next_tile_addr);
	Fman::SerializeStatic(fs, m_bg_next_tile_attrib);
	Fman::SerializeStatic(fs, m_bg_next_tile_hi);
	Fman::SerializeStatic(fs, m_bg_next_tile_lo);
	Fman::SerializeStatic(fs, m_bg_next_tile_id);
	Fman::SerializeStatic(fs, m_dma_page);
	Fman::SerializeStatic(fs, m_dma_addr);
	Fman::SerializeStatic(fs, m_dma_data);
	Fman::SerializeStatic(fs, m_dma_transfer);
	Fman::SerializeStatic(fs, m_dma_dummy);
	Fman::SerializeStatic(fs, m_bg_shifter_pattern_lo);
	Fman::SerializeStatic(fs, m_bg_shifter_pattern_hi);
	Fman::SerializeStatic(fs, m_bg_shifter_attrib_hi);
	Fman::SerializeStatic(fs, m_bg_shifter_pattern_lo);
	Fman::SerializeStatic(fs, m_secondary_oam_addr);
	Fman::SerializeStatic(fs, m_secondary_oam_val);
	Fman::SerializeStatic(fs, m_oam_copy_buffer);
	Fman::SerializeStatic(fs, m_current_sprite_addr);
	Fman::SerializeStatic(fs, m_current_oam_pos);
	Fman::SerializeStatic(fs, m_current_sprite_count);
	Fman::SerializeStatic(fs, m_added_sprite_0);
	Fman::SerializeStatic(fs, m_oam_keep_copying);
	Fman::SerializeStatic(fs, m_oam_sprite_bounded);
	Fman::SerializeStatic(fs, m_oam_m);
	Fman::SerializeStatic(fs, m_oam_n);
	Fman::SerializeStatic(fs, m_scanline);
	Fman::SerializeStatic(fs, m_cycle);
	Fman::SerializeStatic(fs, m_data_buffer);
	Fman::SerializeStatic(fs, m_oam_dma);
	Fman::SerializeStatic(fs, m_oam_addr);
	Fman::SerializeStatic(fs, m_ppu_ctrl.reg);
	Fman::SerializeStatic(fs, m_ppu_status.reg);
	Fman::SerializeStatic(fs, m_ppu_mask.reg);

	Fman::SerializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_hi);
	Fman::SerializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_lo);
	Fman::SerializeArrayStoresStatic<u8>(fs, m_secondary_OAM);
	Fman::SerializeArrayStoresStatic<SpriteInfo>(fs, m_scanline_sprites);
	Fman::SerializeArrayStoresStatic<ObjectAttributeEntry>(fs, m_OAM);
	Fman::SerializeArrayStoresStatic<u8>(fs, m_palette_ram_indexes);
	Fman::SerializeArrayStoresStatic<u32>(fs, m_palettes_show);
	Fman::SerializeArrayStoresStatic<u8>(fs, m_ram);
	Fman::SerializeArrayStoresStatic<u8>(fs, m_pattern_tables);
	Fman::SerializeArrayStoresStatic<u32>(fs, { m_pattern_tables_show, static_cast<size_t>( 128 * 128 * 2 ) });
	Fman::SerializeArrayStoresStatic<u32>(fs, { m_screen, static_cast<size_t>( m_conf.width * m_conf.height ) });
}

void PPU::Deserialize(std::istream& fs)
{
	Fman::DeserializeStatic(fs, m_x);
	Fman::DeserializeStatic(fs, m_w);
	Fman::DeserializeStatic(fs, m_w);
	Fman::DeserializeStatic(fs, m_t);
	Fman::DeserializeStatic(fs, m_frames);
	Fman::DeserializeStatic(fs, m_scanline_done);
	Fman::DeserializeStatic(fs, m_frame_done);
	Fman::DeserializeStatic(fs, m_bg_next_tile_addr);
	Fman::DeserializeStatic(fs, m_bg_next_tile_attrib);
	Fman::DeserializeStatic(fs, m_bg_next_tile_hi);
	Fman::DeserializeStatic(fs, m_bg_next_tile_lo);
	Fman::DeserializeStatic(fs, m_bg_next_tile_id);
	Fman::DeserializeStatic(fs, m_dma_page);
	Fman::DeserializeStatic(fs, m_dma_addr);
	Fman::DeserializeStatic(fs, m_dma_data);
	Fman::DeserializeStatic(fs, m_dma_transfer);
	Fman::DeserializeStatic(fs, m_dma_dummy);
	Fman::DeserializeStatic(fs, m_bg_shifter_pattern_lo);
	Fman::DeserializeStatic(fs, m_bg_shifter_pattern_hi);
	Fman::DeserializeStatic(fs, m_bg_shifter_attrib_hi);
	Fman::DeserializeStatic(fs, m_bg_shifter_pattern_lo);
	Fman::DeserializeStatic(fs, m_secondary_oam_addr);
	Fman::DeserializeStatic(fs, m_secondary_oam_val);
	Fman::DeserializeStatic(fs, m_oam_copy_buffer);
	Fman::DeserializeStatic(fs, m_current_sprite_addr);
	Fman::DeserializeStatic(fs, m_current_oam_pos);
	Fman::DeserializeStatic(fs, m_current_sprite_count);
	Fman::DeserializeStatic(fs, m_added_sprite_0);
	Fman::DeserializeStatic(fs, m_oam_keep_copying);
	Fman::DeserializeStatic(fs, m_oam_sprite_bounded);
	Fman::DeserializeStatic(fs, m_oam_m);
	Fman::DeserializeStatic(fs, m_oam_n);
	Fman::DeserializeStatic(fs, m_scanline);
	Fman::DeserializeStatic(fs, m_cycle);
	Fman::DeserializeStatic(fs, m_data_buffer);
	Fman::DeserializeStatic(fs, m_oam_dma);
	Fman::DeserializeStatic(fs, m_oam_addr);
	Fman::DeserializeStatic(fs, m_ppu_ctrl.reg);
	Fman::DeserializeStatic(fs, m_ppu_status.reg);
	Fman::DeserializeStatic(fs, m_ppu_mask.reg);

	Fman::DeserializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_hi);
	Fman::DeserializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_lo);
	Fman::DeserializeArrayStoresStatic<u8>(fs, m_secondary_OAM);
	Fman::DeserializeArrayStoresStatic<SpriteInfo>(fs, m_scanline_sprites);
	Fman::DeserializeArrayStoresStatic<ObjectAttributeEntry>(fs, m_OAM);
	Fman::DeserializeArrayStoresStatic<u8>(fs, m_palette_ram_indexes);
	Fman::DeserializeArrayStoresStatic<u32>(fs, m_palettes_show);
	Fman::DeserializeArrayStoresStatic<u8>(fs, m_ram);
	Fman::DeserializeArrayStoresStatic<u8>(fs, m_pattern_tables);
	Fman::DeserializeArrayStoresStatic<u32>(fs, { m_pattern_tables_show, static_cast<size_t>( 128 * 128 * 2 ) });
	Fman::DeserializeArrayStoresStatic<u32>(fs, { m_screen, static_cast<size_t>( m_conf.width * m_conf.height ) });
}
