...
static Ui::Application* s_instance = nullptr;
...
void Application::init()
{
    ...
    m_window = SDL_CreateWindow(m_config.name.c_str(), SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_config.w, m_config.h, window_flags);
    if (m_window == nullptr)
    {
    ...
    if (SDL_Vulkan_CreateSurface(m_window, g_Instance, &surface) == 0)
    {
