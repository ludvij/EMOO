...
void PPU::Serialize(std::ostream& fs)
{
	varf::SerializeStatic(fs, m_x);
	varf::SerializeStatic(fs, m_w);
	varf::SerializeStatic(fs, m_w);
	varf::SerializeStatic(fs, m_t);
	varf::SerializeStatic(fs, m_frames);
	varf::SerializeStatic(fs, m_scanline_done);
	varf::SerializeStatic(fs, m_frame_done);
	varf::SerializeStatic(fs, m_bg_next_tile_addr);
	varf::SerializeStatic(fs, m_bg_next_tile_attrib);
	varf::SerializeStatic(fs, m_bg_next_tile_hi);
	varf::SerializeStatic(fs, m_bg_next_tile_lo);
	varf::SerializeStatic(fs, m_bg_next_tile_id);
	varf::SerializeStatic(fs, m_dma_page);
	varf::SerializeStatic(fs, m_dma_addr);
	varf::SerializeStatic(fs, m_dma_data);
	varf::SerializeStatic(fs, m_dma_transfer);
	varf::SerializeStatic(fs, m_dma_dummy);
	varf::SerializeStatic(fs, m_bg_shifter_pattern_lo);
	varf::SerializeStatic(fs, m_bg_shifter_pattern_hi);
	varf::SerializeStatic(fs, m_bg_shifter_attrib_hi);
	varf::SerializeStatic(fs, m_bg_shifter_pattern_lo);
	varf::SerializeStatic(fs, m_secondary_oam_addr);
	varf::SerializeStatic(fs, m_secondary_oam_val);
	varf::SerializeStatic(fs, m_oam_copy_buffer);
	varf::SerializeStatic(fs, m_current_sprite_addr);
	varf::SerializeStatic(fs, m_current_oam_pos);
	varf::SerializeStatic(fs, m_current_sprite_count);
	varf::SerializeStatic(fs, m_added_sprite_0);
	varf::SerializeStatic(fs, m_oam_keep_copying);
	varf::SerializeStatic(fs, m_oam_sprite_bounded);
	varf::SerializeStatic(fs, m_oam_m);
	varf::SerializeStatic(fs, m_oam_n);
	varf::SerializeStatic(fs, m_scanline);
	varf::SerializeStatic(fs, m_cycle);
	varf::SerializeStatic(fs, m_data_buffer);
	varf::SerializeStatic(fs, m_oam_dma);
	varf::SerializeStatic(fs, m_oam_addr);
	varf::SerializeStatic(fs, m_ppu_ctrl.reg);
	varf::SerializeStatic(fs, m_ppu_status.reg);
	varf::SerializeStatic(fs, m_ppu_mask.reg);

	varf::SerializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_hi);
	varf::SerializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_lo);
	varf::SerializeArrayStoresStatic<u8>(fs, m_secondary_OAM);
	varf::SerializeArrayStoresStatic<SpriteInfo>(fs, m_scanline_sprites);
	varf::SerializeArrayStoresStatic<ObjectAttributeEntry>(fs, m_OAM);
	varf::SerializeArrayStoresStatic<u8>(fs, m_palette_ram_indexes);
	varf::SerializeArrayStoresStatic<u32>(fs, m_palettes_show);
	varf::SerializeArrayStoresStatic<u8>(fs, m_ram);
	varf::SerializeArrayStoresStatic<u8>(fs, m_pattern_tables);
	varf::SerializeArrayStoresStatic<u32>(fs, { m_pattern_tables_show, static_cast<size_t>( 128 * 128 * 2 ) });
	varf::SerializeArrayStoresStatic<u32>(fs, { m_screen, static_cast<size_t>( m_conf.width * m_conf.height ) });
}

void PPU::Deserialize(std::istream& fs)
{
	varf::DeserializeStatic(fs, m_x);
	varf::DeserializeStatic(fs, m_w);
	varf::DeserializeStatic(fs, m_w);
	varf::DeserializeStatic(fs, m_t);
	varf::DeserializeStatic(fs, m_frames);
	varf::DeserializeStatic(fs, m_scanline_done);
	varf::DeserializeStatic(fs, m_frame_done);
	varf::DeserializeStatic(fs, m_bg_next_tile_addr);
	varf::DeserializeStatic(fs, m_bg_next_tile_attrib);
	varf::DeserializeStatic(fs, m_bg_next_tile_hi);
	varf::DeserializeStatic(fs, m_bg_next_tile_lo);
	varf::DeserializeStatic(fs, m_bg_next_tile_id);
	varf::DeserializeStatic(fs, m_dma_page);
	varf::DeserializeStatic(fs, m_dma_addr);
	varf::DeserializeStatic(fs, m_dma_data);
	varf::DeserializeStatic(fs, m_dma_transfer);
	varf::DeserializeStatic(fs, m_dma_dummy);
	varf::DeserializeStatic(fs, m_bg_shifter_pattern_lo);
	varf::DeserializeStatic(fs, m_bg_shifter_pattern_hi);
	varf::DeserializeStatic(fs, m_bg_shifter_attrib_hi);
	varf::DeserializeStatic(fs, m_bg_shifter_pattern_lo);
	varf::DeserializeStatic(fs, m_secondary_oam_addr);
	varf::DeserializeStatic(fs, m_secondary_oam_val);
	varf::DeserializeStatic(fs, m_oam_copy_buffer);
	varf::DeserializeStatic(fs, m_current_sprite_addr);
	varf::DeserializeStatic(fs, m_current_oam_pos);
	varf::DeserializeStatic(fs, m_current_sprite_count);
	varf::DeserializeStatic(fs, m_added_sprite_0);
	varf::DeserializeStatic(fs, m_oam_keep_copying);
	varf::DeserializeStatic(fs, m_oam_sprite_bounded);
	varf::DeserializeStatic(fs, m_oam_m);
	varf::DeserializeStatic(fs, m_oam_n);
	varf::DeserializeStatic(fs, m_scanline);
	varf::DeserializeStatic(fs, m_cycle);
	varf::DeserializeStatic(fs, m_data_buffer);
	varf::DeserializeStatic(fs, m_oam_dma);
	varf::DeserializeStatic(fs, m_oam_addr);
	varf::DeserializeStatic(fs, m_ppu_ctrl.reg);
	varf::DeserializeStatic(fs, m_ppu_status.reg);
	varf::DeserializeStatic(fs, m_ppu_mask.reg);

	varf::DeserializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_hi);
	varf::DeserializeArrayStoresStatic<u16>(fs, m_sprite_shifter_pattern_lo);
	varf::DeserializeArrayStoresStatic<u8>(fs, m_secondary_OAM);
	varf::DeserializeArrayStoresStatic<SpriteInfo>(fs, m_scanline_sprites);
	varf::DeserializeArrayStoresStatic<ObjectAttributeEntry>(fs, m_OAM);
	varf::DeserializeArrayStoresStatic<u8>(fs, m_palette_ram_indexes);
	varf::DeserializeArrayStoresStatic<u32>(fs, m_palettes_show);
	varf::DeserializeArrayStoresStatic<u8>(fs, m_ram);
	varf::DeserializeArrayStoresStatic<u8>(fs, m_pattern_tables);
	varf::DeserializeArrayStoresStatic<u32>(fs, { m_pattern_tables_show, static_cast<size_t>( 128 * 128 * 2 ) });
	varf::DeserializeArrayStoresStatic<u32>(fs, { m_screen, static_cast<size_t>( m_conf.width * m_conf.height ) });
}
